...
display tqlabor_s0,tlabor_s0,cquota,rgdp.l,gprod.l,emkup,fact,report8,report12;
  );
);

subsidy_h(t,sub_elec)=sub_t(t,sub_elec);
execute_unload "trend.gdx" subsidy_h
execute 'gdxxrw.exe trend.gdx  par=subsidy_h  rng=A80:J90';
