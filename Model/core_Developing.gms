...
$prod:ybt(bt)$Switch_bt(bt)  s:0 sa(s):esub_bt("NR",bt)   gva(sa):esub_bt("gva",bt)  gl(gva):esub_l("l") sva(sa):esub_bt("SVA",bt)  sl(sva):esub_l("l") roil(sa):0 coal(sa):0 gas(sa):0
    o:pbt(bt)                                   q:1
