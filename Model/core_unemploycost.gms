...
umc                  !unemployment Social cost

t_re(sub_elec)$cfe(sub_elec)       !FIT for renewable energy

fee_re$Switch_fee         !additional fees to cover renewable subsidy
...
$prod:y(i)$elec(i)   s:esub_gt   b(s):100 a(b):esub_pe     c(a):esub_be
        o:py(i)                               q:output0(i)      a:ra  N:fee_re$Switch_fee
...
$prod:yelec(sub_elec)$hnb(sub_elec)  s:esub_elec("NR",sub_elec) a:esub_elec("IT",sub_elec) va(a):esub_elec("KL",sub_elec) l(va):esub_l("l")
        o:pelec(sub_elec)$hne(sub_elec)  q:outputelec0(sub_elec)              p:((1-taxelec0(sub_elec))*costelec0(sub_elec))  a:ra  N:t_re(sub_elec)
...
* Social cost of umemployment labor
$constraint:umc$Switch_umc
umc =e=  sum(lm, gprod*ur(lm)*pls(lm)*tlabor_s0(lm));

$constraint:umc$(not Switch_umc)
umc =e=  0;
...
$constraint:fee_re$Switch_fee
         sum(sub_elec,yelec(sub_elec)*outputelec0(sub_elec)*costelec0(sub_elec)*pelec(sub_elec)*(taxelec0(sub_elec)-t_re(sub_elec)-subelec_b(sub_elec)))=e= y("elec")*output0("elec") *py("elec")*fee_re;
...
fee_re.l$Switch_fee=0;
fee_re.lo$Switch_fee=-inf;
pu.fx=1;
...
*== subsidy
subelec0(sub_elec)=subelec0(sub_elec)*1;
*subelec0("solar")=subelec0("solar")*1.5;
*tax_s("wind")=0;
*ret0("wind")=ret0("wind")*10;
