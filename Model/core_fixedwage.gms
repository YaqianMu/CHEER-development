...
$constraint:t_re(sub_elec)$(hne(sub_elec))
        t_re(sub_elec) =e= -subelec0(sub_elec)+taxelec0(sub_elec);

$constraint:t_re(sub_elec)$(wsb(sub_elec) and tax_s eq 0)
        yelec(sub_elec) =e=ret0(sub_elec);

$constraint:t_re(sub_elec)$(wsb(sub_elec) and tax_s eq 1)
         t_re(sub_elec) =e= -subelec0(sub_elec)+taxelec0(sub_elec);
*         t_re(sub_elec) =e= -subelec0(sub_elec)+taxelec0(sub_elec);

$constraint:fee_re$Switch_fee
         sum(sub_elec,yelec(sub_elec)*outputelec0(sub_elec)*costelec0(sub_elec)*pelec(sub_elec)*(subelec0(sub_elec)-subelec_b(sub_elec)))=e= y("elec")*output0("elec") *py("elec")*fee_re;
...
$constraint:gprod2(lm)$(Switch_um )
   pls(lm)=e=awage_e(lm);
